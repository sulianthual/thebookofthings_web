...
class obj_musics:
    ...
    def setup(self):
        ...
        # general
        self.dict['error']=( 'general/error.ogg' , 1 )# when a music cant be found
        self.dict['tension']=( 'general/whitenoise_ambient.ogg' , 0.8 )# tense silence
        self.dict['test']=self.dict['tension']
        # upbeat musics
        # ch0
        self.dict['piano']=( 'ch0/POL-you-and-me-short.ogg' , 0.2 )# main theme (soft piano)
        # ch1
        self.dict['hero']=( 'ch1/POL-blob-tales-short.ogg' , tempo )# draw the hero (energetic fun)
        # ch2
        self.dict['partner']=( 'ch2/POL-pet-park-short.ogg' , tempo )# partner music (cute)
        # ch3
        self.dict['villain']=( 'ch3/POL-spooky-toyland-short.ogg' , tempo )# villain music (evil)
        self.dict['gunfight']=( 'ch3/POL-knock-out-short.ogg' , tempo )
        self.dict['tower']=( 'ch3/POL-nuts-and-bolts-short.ogg' , tempo )# tower music (technologic)
        self.dict['bug']=( 'ch3/POL-bomb-carrier-short.ogg' , tempo )# bug (tense)
        # ch4
        self.dict['ch4']=( 'ch4/POL-azure-waters-short.ogg' , tempo )# start day (energetic cute)
        self.dict['bunny']=( 'ch4/POL-lone-wolf-short.ogg' , tempo )
        self.dict['forest']=( 'ch4/POL-illusion-castle-short.ogg' , tempo )
        # ch5
        self.dict['ch5']=( 'ch5/POL-king-of-coins-short.ogg' , tempo )# start the day (energetic)
        self.dict['elder']=( 'ch5/POL-find-the-exit-short.ogg' , tempo )# elder music (for rps game)
        self.dict['winds']=( 'ch5/wind woosh loop.ogg' , 1 )# winds on top of highest peak
        # ch6
        self.dict['ch6']=self.dict['ch5']
        self.dict['sailor']=( 'ch6/POL-jungle-hideout-short.ogg' , tempo )# sailor music (jungle jazz)
        self.dict['stealth']=( 'ch6/POL-stealth-mode-short.ogg' , tempo )# stealth game (epiiiic)
        self.dict['racing']=( 'ch6/POL-tlalok-temple-short.ogg' , tempo )# racing game (energetic)
        # ch7
        self.dict['ch7']=( 'ch7/POL-galactic-trek-short.ogg' , tempo )# start the last day (very energetic)
        self.dict['fistfight']=( 'ch7/POL-time-attack-short.ogg' , tempo )
        self.dict['mechs']=( 'ch7/POL-underground-army-short.ogg' , tempo )# mech transformations (technologic energetic)
        self.dict['mechfight']=self.dict['fistfight']
        self.dict['victory']=( 'ch7/POL-gold-gryphons-short.ogg' , tempo )# final victory (epic positive)
        # ch8
        # (reuses all musics)
...
class obj_sounds:
    ...
    def setup(self):
        ...
        self.dict['erasebook']=( 'general/link (3).ogg' , 1 )# erase the book
        self.dict['revealscary']=( 'general/reveal_reversed-suspenseful-harp-3shorter.ogg' , 1 )# erase the book
        #
        ...
        # ch0
        self.dict['bookscene']=( 'book/link (3).ogg' , 0.5 )# a scene with the book of things
        self.dict['book2']=( 'book/part (3).ogg' , 0.7 )
        self.dict['book1']=( 'book/wall (4).ogg' , 1 )
        self.dict['book3']=( 'book/wall (2).ogg' , 1 )
        # ch1
        self.dict['hero1']=( 'hero/grunt_male-grunt-disapprove.ogg' , 1 )
        self.dict['hero2']=( 'hero/haha01.ogg' , 1 )
        self.dict['hero3']=( 'hero/sniff.ogg' , 1 )
        self.dict['hero4']=( 'hero/grunt__oh-1.ogg' , 1 )
        self.dict['hero5']=( 'hero/haha_laugh1.ogg' , 1 )
        ...
        self.dict['partner3']=( 'partner/giggle_small-giggle.ogg' , 1 )
        self.dict['partner_scared']=( 'partner/grunt_female__oh-gah.ogg' , 1 )# oh no for any purpose
        # ch3
        self.dict['villain1']=( 'villain/grunt_01.ogg' , 1 )
        self.dict['villain2']=( 'villain/haha_evil-laughshort.ogg' , 0.5 )
        ...
        self.dict['tower_elec']=( 'tower/paralyzer-discharge-03.ogg' , 1 )
        self.dict['tower_hurt']=( 'tower/die_02.ogg' , 1 )
        self.dict['tower1']=( 'tower/robot_1.ogg' , 0.5 )
        self.dict['tower2']=( 'tower/robot_2.ogg' , 0.5 )
        self.dict['tower3']=( 'tower/robot_3.ogg' , 0.5 )
        self.dict['tower4']=( 'tower/robot_4.ogg' , 0.5 )
        self.dict['tower5']=( 'tower/r2d2.ogg' , 1 )
        self.dict['tower6']=( 'tower/robot_classic-computing-sound_short.ogg' , 1 )
        # self.dict['bug1']=( 'bug/move.ogg' , 1 )
        self.dict['bug1']=( 'bug/misc_menu.ogg' , 1 )
        self.dict['bug2']=( 'bug/negative_2.ogg' , 1 )
        self.dict['bugitem1']=( 'bug/clean_trumpet.ogg' , 1 )
        self.dict['bugitem2']=( 'bug/tadaam.ogg' , 0.7 )
        # ch4
        self.dict['bunny1']=( 'bunny/cute_07.ogg' , 1 )
        # self.dict['bunny2']=( 'bunny/giggle__dumb-heh.ogg' , 1 )# hinhin
        self.dict['bunny2']=( 'bunny/evil_laugh_02.ogg' , 1 )# hinhin
        self.dict['bunny3']=( 'bunny/cute_08.ogg' , 1 )# oh
        self.dict['bunny4']=( 'bunny/grunt_femalegrunt1.ogg' , 1 )# grrr
        self.dict['bunny5']=( 'bunny/Pixie.ogg' , 1 )# niaaaah
        self.dict['bunny_hit']=( 'bunny/Punch4.ogg' , 1 )
        self.dict['bunny_cave']=( 'bunny/monster-growl_with-reverb.ogg' , 1 )
        # ch5
        self.dict['elder1']=( 'elder/grunt_malegrunt1.ogg' , 1 )
        self.dict['elder2']=( 'elder/hahaha_elder.ogg' , 1 )
        self.dict['elder3']=( 'elder/grunt_malegrunt3.ogg' , 1 )
        self.dict['elder4']=( 'elder/haha_evil-man-laughing.ogg' , 1 )
        self.dict['elder5']=( 'elder/weird_07.ogg' , 1 )
        self.dict['elder6']=( 'elder/grunt_malegrunt2.ogg' , 1 )
        # ch6
        self.dict['sailor1']=( 'sailor/humanYell3.ogg' , 1 )
        self.dict['sailor2']=( 'sailor/uhuh.ogg' , 1 )
        self.dict['sailor3']=( 'sailor/humanYell4.ogg' , 1 )
        self.dict['sailor4']=( 'sailor/drunk-hic.ogg' , 1 )
        self.dict['sailor5']=( 'sailor/pirate_arrshort2.ogg' , 0.5 )
        ...
        self.dict['skeleton2']=( 'skeleton/ghost_SpiritShout.ogg' , 0.4 )
        self.dict['skeleton4']=( 'skeleton/ghostshort1.ogg' , 0.4 )
        self.dict['skeleton5']=( 'skeleton/ghost_scream1.ogg' , 1 )
        ...
        self.dict['sunrise_end']=( 'world/sunrise/rooster2.ogg' , 0.7 )
        # sunset
        self.dict['sunset_start']=( 'world/sunset/Lose4.ogg' , 1 )
        self.dict['sunset_end']=( 'world/sunset/howling_shorter.ogg' , 2 )
        # wakeup
        ...
        self.dict['wakeup_wake2']=( 'world/wakeup/yawn_male-yawnshorter.ogg' , 1 )
        ...
        self.dict['fishing_shoot']=( 'world/fish/gun-5.ogg' , 0.5 )
        self.dict['fishing_hit']=( 'world/fish/die_02.ogg' , 1 )
        self.dict['fishing_throw']=( 'world/fish/swish-9.ogg' , 0.5 )
        self.dict['fishing_boomerang']=( 'world/fish/swosh-06.ogg' , 2 )#
        self.dict['fishing_lightshoot']=( 'world/fish/lightshoot.ogg' , 2 )#
        self.dict['fishing_lighthit']=( 'world/fish/lighthit.ogg' , 1 )#
        # eating
        self.dict['eat']=( 'world/eat/eatgulp2.ogg' , 1 )
        self.dict['eatend']=( 'world/eat/eat_burp.ogg' , 1 )
        self.dict['eatendpowerup']=( 'world/eat/1up3.ogg' , 1 )
        # mail
        ...
        self.dict['serenade_ambience']=( 'world/serenade/record_player_loop.ogg' , 1 )# loop
        ...
        self.dict['kiss_kiss']=( 'world/kiss/kiss_cartoon-kiss-cjohnstone.ogg' , 1 )
        self.dict['kiss_cheer']=( 'world/kiss/haha-girlp2.ogg' , 1 )
        self.dict['kiss_cheer2']=( 'world/kiss/haha01.ogg' , 1 )
        self.dict['kiss_ohgah']=( 'world/kiss/grunt_female__oh-gah.ogg' , 1 )
        # travel
        self.dict['travel_forest']=( 'world/travel/forest-birds-loop-02.ogg' , 1 )
        self.dict['travel_ocean']=( 'world/travel/ocean-waves.ogg' , 1 )
        self.dict['travel_winds']=( 'world/travel/wind woosh loop.ogg' , 1 )
        self.dict['travel_chop']=( 'world/travel/chop-into-wood-little-debris.ogg' , 1 )
        self.dict['travel_choplast']=( 'world/travel/Cure.ogg' , 1 )
        self.dict['travel_pickflower']=( 'world/travel/click18.ogg' , 1 )
        self.dict['travel_enter']=( 'world/travel/1up3.ogg' , 1 )
        # dodgebullets
        self.dict['dodgebullets_start']=( 'world/dodgebullets/fight_lowreverb.ogg' , 1 )
        ...
        self.dict['dodgebullets_jump']=( 'world/dodgebullets/sfx_movement_jump13.ogg' , 0.3 )
        self.dict['dodgebullets_crouch']=( 'world/dodgebullets/swish-9.ogg' , 0.5 )
        # climb
        self.dict['climb_jump']=( 'world/climb/sfx_movement_jump13.ogg' , 0.3 )
        self.dict['climb_fall']=( 'world/climb/fall4.ogg' , 1 )
        # rps=rock paper scissors (8 sounds=max?)
        self.dict['rps_select']=( 'world/rps/select.ogg' , 1 )
        self.dict['rps_start']=( 'world/rps/fight_lowreverb.ogg' , 1 )
        ...
        # self.dict['stealth_alarm']=( 'skeleton/ghost_scream1.ogg' , 1 )
        self.dict['stealth_alarm']=( 'world/stealth/alarmwtf-02.ogg' , 1 )
        # ride cow
        ...
        self.dict['ridecow_start']=( 'world/ridecow/fight_lowreverb.ogg' , 1 )
        # stomp
        self.dict['stomp_jump']=( 'world/stomp/sfx_movement_jump13.ogg' , 0.3 )
        ...
        self.dict['stomp_kick']=( 'world/stomp/swish-9.ogg', 1 )
        self.dict['stomp_contact']=( 'world/stomp/Punch4.ogg', 1 )
        self.dict['stomp_start']=( 'world/stomp/fight_lowreverb.ogg' , 1 )
        # mech
        ...
        self.dict['mech_start']=( 'world/mech/fight_lowreverb.ogg' , 1 )
        ...
        self.dict['mech_wrong']=( 'world/mech/fail.ogg', 1 )
        # 3d forest
        self.dict['3dforest_gunreload']=( 'world/3dforest/gunreload.ogg' , 0.5 )
        self.dict['3dforest_pickupsax']=( 'world/3dforest/swish-9.ogg' , 1 )
        self.dict['3dforest_shoot']=( 'world/3dforest/gun-5.ogg' , 0.5 )
        self.dict['3dforest_hit']=( 'world/3dforest/die_02.ogg' , 1 )
        self.dict['3dforest_die']=( 'world/3dforest/die_04.ogg' , 1 )
        self.dict['3dforest_bunnyhaha']=( 'world/3dforest/giggle__dumb-heh.ogg' , 1 )
        # self.dict['3dforest_bunnyhaha']=( 'world/3dforest/evil_laugh_02.ogg' , 1 )
        self.dict['3dforest_bunnyscream']=( 'world/3dforest/Pixie.ogg' , 1 )
        self.dict['3dforest_bunnydie']=( 'world/3dforest/squish.ogg', 0.5 )
        self.dict['3dforest_win']=( 'world/3dforest/cheer1.ogg', 0.5 )
        self.dict['3dforest_bunnystrike']=( 'world/3dforest/Punch4.ogg', 1 )
        # master rps
        self.dict['master_fail']=( 'world/rpsmaster/fall4.ogg' , 1 )
        self.dict['master_fold']=( 'world/rpsmaster/paper_01.ogg' , 1 )
        self.dict['master_win']=( 'world/rpsmaster/cheer1.ogg' , 0.2 )
        self.dict['master_count']=( 'world/rpsmaster/FX01.ogg' , 1 )
        self.dict['master_kick']=( 'world/rpsmaster/swish-9.ogg', 1 )
